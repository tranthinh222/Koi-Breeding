...
import type { IItemInventory, IRestResponse } from "../types/backend";
...
export const mockInventory: ItemInventory[] = [
	...
	},
	{
		...
		price: 150,
		description:
			"A striking Koi with a black body and red and white markings.",
		quantity: 2,
	},
	{
		id: 3,
...
export const callFetchInventoryByType = (
	userId: number,
	itemType: InventoryCategory,
) => {
	return apiClient.get<IRestResponse<IItemInventory[]>>("/inventory/type", {
		params: { userId, itemType },
	});
};
