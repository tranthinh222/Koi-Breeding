    ...
    <div className="image-editor-overlay">
      <div className="image-editor">
        <div className="image-editor-header">
          <h2>Edit Avatar</h2>
          <button className="cancel-header-button" onClick={onCancel}>✕</button>
        </div>

        <div className="crop-container" style={{ position: 'relative', height: '300px', overflow: 'hidden' }}>
        ...
        <div className="editor-controls">
          ...
          <div className="flip-controls">
            <button className="flip-horizontal" onClick={() => setFlipH(!flipH)}>
