		...
		try {
			...
			if ("create" === mode) {
				...
				if (koiVarient) {
					...
					throw new Error(
						"The create API did not return the new koi entry.",
					);
				}
				...
				if (koiVarient) {
					...
					throw new Error(
						"The update API did not return the updated koi entry.",
					);
				}
			}
		} catch (error: any) {
		...
		<div className="items-view dictionary-view">
			<div className="items-page-header dictionary-page-header">
				<div className="items-page-heading-copy">
					...
					<p>
						Manage koi varieties, classifications, and base values.
					</p>
				</div>
				<button
					type="button"
			...
			<div className="items-filter-card dictionary-filter-card">
				<div className="dictionary-filter-heading">
					<div>
						...
						<p>
							Enter a partial or full koi name to find matching
							variants.
						</p>
					</div>
					{(search ||
								...
								<tr>
									<td colSpan={6} className="items-empty">
										<div className="dictionary-empty-state">
											<Search size={28} />
											<strong>
												No koi entries found
											</strong>
											<span>
												Try another name or clear the
												active filters.
											</span>
											<button
												type="button"
