...
function Pond({
  ...
  const handleImportKoi = async (koiItem: IItemInventory, quantity: number) => {
    try {
        ...
        <section className={styles.pondShell}>
          ...
          >
            <button
              ...
              title={isHudExpanded ? "Collapse Stats" : "Expand Stats"}
            >
              {isHudExpanded ? <ChevronsLeft /> : <ChevronsRight />}
            </button>
            ...
            <div className={styles.hudContent}>
              ...
              <div className={styles.hudItem} title="Temperature">
                <Thermometer color="#d97706" /> {pond.temperature}°C
              </div>
              <div className={styles.hudSeparator} />

              <div className={styles.hudItem} title="Dissolved Oxygen">
                <Bubbles color="#06b6d4" /> {`${pond.oxygen} mg/L`}
              </div>
              <div className={styles.hudSeparator} />

              <div className={styles.hudItem} title="Water Quality">
                <CheckCheck color="#16a34a" /> {pond.waterQuality}/100
              </div>
              <div className={styles.hudSeparator} />

              <div className={styles.hudItem} title="Environment Score">
                <Gauge color="#7c3aed" /> {pond.environmentScore}/100
              </div>
            </div>
          </div>
          ...
          <div className={styles.header}>
            ...
            >
              <img src="/pond/shopping-cart.png" alt="marketplace" />
            </button>
          </div>
          <div className={styles.footer}>
            ...
            >
              <img src="/pond/information-button.png" alt="pond info" />
            </button>
            <button
              type="button"
              className={styles.navButton}
