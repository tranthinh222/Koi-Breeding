...
public class KoiDictionaryController {
    ...
    public ResponseEntity<Dictionary> createNewKoiDictionary(@Valid @RequestBody Dictionary koiDictionary) {
        Dictionary newKoiDictionary = this.koiDictionaryService.handleCreateKoiDictionary(koiDictionary);
    ...
    public ResponseEntity<Dictionary> updateAKoiDictionary(@Valid @RequestBody Dictionary koiDictionary)
            throws Exception {
        ...
        Dictionary updatedKoiDictionary = this.koiDictionaryService.handleUpdateKoiDictionary(koiDictionary);
    ...
    public ResponseEntity<Dictionary> getKoiDictionaryById(@PathVariable Integer id) throws Exception {
        Dictionary fetchedKoiDictionary = koiDictionaryService.handleFetchKoiDictionaryById(id);
