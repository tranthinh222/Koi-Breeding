...
class SampleData {
    ...
    private static final List<Item> SAMPLE_ITEMS = List.of(
            ...
            new Item(null, "Health Elixir - KAFKA", BigDecimal.valueOf(45.0), 1, ItemType.MEDICINE, EffectType.GROWTH,
                    BigDecimal.valueOf(40.0),
    ...
    public static List<Dictionary> getSampleDictionaryList() {
        return SAMPLE_DICTIONARIES;
    }

    public static List<Item> getSampleItemList() {
        return SAMPLE_ITEMS;
    }
}
