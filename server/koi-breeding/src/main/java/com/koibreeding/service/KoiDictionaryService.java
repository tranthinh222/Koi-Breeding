    ...
    public KoiDictionary handleUpdateKoiDictionary(KoiDictionary koiDictionary) {
        ...
        if (currentKoiDictionary != null) {
            currentKoiDictionary.setName(
                    koiDictionary.getName() != null ? koiDictionary.getName() : currentKoiDictionary.getName());
            currentKoiDictionary.setShape(
                    koiDictionary.getShape() != null ? koiDictionary.getShape() : currentKoiDictionary.getShape());
            currentKoiDictionary.setScaleType(koiDictionary.getScaleType() != null ? koiDictionary.getScaleType()
                    : currentKoiDictionary.getScaleType());

            if (koiDictionary.getVariety() != null) {
                Variety variety = this.varietyService.handleFetchVarietyById(koiDictionary.getVariety().getId());
                currentKoiDictionary.setVariety(variety);
            }

            currentKoiDictionary.setOrigin(
                    koiDictionary.getOrigin() != null ? koiDictionary.getOrigin() : currentKoiDictionary.getOrigin());
            currentKoiDictionary
                    .setBaseMaxLength(koiDictionary.getBaseMaxLength() != null ? koiDictionary.getBaseMaxLength()
                            : currentKoiDictionary.getBaseMaxLength());
            currentKoiDictionary
                    .setBaseGrowthRate(koiDictionary.getBaseGrowthRate() != null ? koiDictionary.getBaseGrowthRate()
                            : currentKoiDictionary.getBaseGrowthRate());
            currentKoiDictionary.setMidAge(
                    koiDictionary.getMidAge() != null ? koiDictionary.getMidAge() : currentKoiDictionary.getMidAge());
            currentKoiDictionary.setAlphaWeight(koiDictionary.getAlphaWeight() != null ? koiDictionary.getAlphaWeight()
                    : currentKoiDictionary.getAlphaWeight());
            currentKoiDictionary.setBasePrice(koiDictionary.getBasePrice() != null ? koiDictionary.getBasePrice()
                    : currentKoiDictionary.getBasePrice());
            currentKoiDictionary.setAlphaPrice(koiDictionary.getAlphaPrice() != null ? koiDictionary.getAlphaPrice()
