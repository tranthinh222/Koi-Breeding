...
public class ShopService {
    ...
    public ResPurchaseDto purchaseShopItem(Integer userId, Integer itemId, Integer quantity) {
        ...
        if (item.getItemType() == ItemType.CURRENCY) {
            throw new IllegalArgumentException("Currency packages must be paid through the payment endpoint");
        }
        ...
        notificationService.createAndSend(userId, NotificationType.PURCHASE_SUCCESS, "Purchase successful",
                description);
