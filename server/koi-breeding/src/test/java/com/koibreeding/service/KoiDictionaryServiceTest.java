...
public class KoiDictionaryServiceTest {
    ...
    public void createKoiDictionary_shouldReturnKoiDictionary() {
        ...
        Dictionary outputKoiDictionary = new Dictionary(
                1,
                "Kohaku",
                Shape.STANDARD,
                ScaleType.WAGOI,
        ...
        Dictionary result = this.koiDictionaryService.handleCreateKoiDictionary(inputKoiDictionary);
    ...
    public void updateKoiDictionary_shoudReturnUpdatedKoiDictionary_whenCurrentKoiDictionaryExist() {
        ...
        Dictionary oldKoiDictionary = new Dictionary(
                1,
                "Kohaku",
                Shape.STANDARD,
                ScaleType.WAGOI,
        ...
        Dictionary result = this.koiDictionaryService.handleUpdateKoiDictionary(inputKoiDictionary);
    ...
    public void fetchKoiDictionary_shouldReturnKoiDictionary_whenIdValid() {
        ...
        Dictionary result = this.koiDictionaryService.handleFetchKoiDictionaryById(validId);
    ...
    public void fetchKoiDictionary_shouldReturnNull_whenIdInvalid() {
        ...
        Dictionary result = this.koiDictionaryService.handleFetchKoiDictionaryById(invalidId);
    ...
    public void fetchAllKoiDictionaries_shouldReturnResultPagination_whenHasData() {
        Variety mockVariety = new Variety(1, "Kohaku", "");
        List<Dictionary> mockKoiDictionaryList = new ArrayList<>();
        for (int i = 0; i < 10; ++i) {
            mockKoiDictionaryList.add(new Dictionary(
                    i + 1,
                    "Mock Kohaku #" + (i + 1),
                    Shape.STANDARD,
                    ScaleType.WAGOI,
        ...
        Page<Dictionary> mockPageKoiDictionary = new PageImpl<>(mockKoiDictionaryList, inputPageable, totalElements);
